...
now = datetime.now()
FILE = "/usr/local/sf-airflow/docker-compose/downloads/NAWS_A2E197.csv"
...
Download_CSV = BashOperator(
    ...
    bash_command="wget https://www.dol.gov/sites/dolgov/files/ETA/naws/pdfs/NAWS_A2E197.csv -O /usr/local/sf-airflow/docker-compose/downloads/NAWS_A2E197.csv",
    dag=dag,
)
