...
mergeairbus = PythonOperator(task_id='mergeairbus', python_callable=triggerBatch, op_kwargs={"api_url":"https://api.eu-de.ae.cloud.ibm.com/v3/analytics_engines/2f641c08-2aee-438c-b8a0-eb1738f88c58/spark_applications","access_token":Variable.get("Access_Token"), "jobDetails":{"application_details": {      
        ...
        "arguments": ["cos://ingestedairbusdata.Airbus/portfolio/dt=20230515/01_NBS_Portfolio_Bristol_230216.csv","cos://ingestedairbusdata.Airbus/twinn/dt=20230515/02_NBS_Portfolio_Bristol_230216_TWINN.csv","cos://ingestedairbusdata.Airbus/latlong/dt=20230515/03_NBS_Portfolio_Bristol_230216_LatLon.csv"],
...
start_load_airbus >> checkToken >> mergeairbus >> checkMergeAirbusStatus >> end_load_airbus
